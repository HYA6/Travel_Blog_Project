...
public class PostDto {
	...
	public static PostDto toDto(Post post) {
		...
		return new PostDto(post.getPostId(), post.getPostForm(), post.getPostSubject(), post.getPostStratDate(), 
				post.getPostEndDate(), post.getPostPlace(), post.getPostContent(), post.getPostTag(), 
